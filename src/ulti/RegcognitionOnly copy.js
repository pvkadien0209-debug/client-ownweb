...
/*
Yêu cầu: (1) Giữ nguyên logic khác

(2) thêm vào bấm vào INFO sẽ popup ra 1 ô textarea để hiển thị các phiên âm tham khảo (IPA-02, IPA-03, IPA-04) của câu vừa đọc. Người dùng có thể copy hoặc dán vào ô inputString để tra cứu.
trong đó sẽ có 
 /ô nhập tìm kiếm câu cần tra cứu => inputstring
tìm kiếm sẽ Hiển thị các ô nhưu funtion => bấm vào sẽ dán vào textArea
data =  phrasesArray
                    <textarea
